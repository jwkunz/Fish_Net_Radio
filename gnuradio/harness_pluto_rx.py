...
# Title: Harness of ADALM Pluto RX
...
class harness_pluto_rx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Harness of ADALM Pluto RX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Harness of ADALM Pluto RX")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "harness_pluto_rx")
        ...
        self.soapy_plutosdr_source_0 = soapy.source(dev, "fc32", 1, '192.168.2.1',
    ...
    def set_radio_gain_db(self, radio_gain_db):
        ...
        self.soapy_plutosdr_source_0.set_gain(0, min(max(self.radio_gain_db, 0.0), 73.0))
...
def main(top_block_cls=harness_pluto_rx, options=None):

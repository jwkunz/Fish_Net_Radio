...
class harness_hackrf_tx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Harness of HackRF TX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Harness of HackRF TX")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "harness_hackrf_tx")
        ...
        self.soapy_hackrf_sink_0 = soapy.sink(dev, "fc32", 1, 'hackrf=0000000000000000f77c60dc2540a6c3',
    ...
    def set_radio_gain_db(self, radio_gain_db):
        ...
        self.soapy_hackrf_sink_0.set_gain(0, 'VGA', min(max(self.radio_gain_db, 0.0), 47.0))
...
def main(top_block_cls=harness_hackrf_tx, options=None):
